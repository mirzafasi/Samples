 ...
 * database operations.
 * This interface acts as the business layer.
 * @author mirza
 *
 */
public interface ITwitterAnalyzer {
	...
	/**
	 * Method gets Sample data from Twitter using the Twitter Streaming API
	 * @param count - count of records to be retrieved from Twitter
	 */
